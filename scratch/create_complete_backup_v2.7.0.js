    ...
    const payload = {
        ...
        html: `
            <div style="font-family: sans-serif; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eaeaea; border-radius: 12px; background: #fafafa;">
                ...
                <h3 style="color: #4b5563;">Cambios recientes en esta versión (v2.7.0):</h3>
                <ul>
                    <li><b>Ubicación en Vivo en Matriz de Permisos:</b> Se añadió una nueva columna "Ubicación en Vivo" a la matriz de seguridad para poder ocultar/mostrar este módulo a empleados específicos (loc_ve y loc_mod).</li>
                    <li><b>Ocultamiento Condicional:</b> El globo de Ubicación en Vivo desaparece para cualquier empleado que tenga su permiso 'Ve' deshabilitado en su perfil.</li>
                    <li><b>Esquema DB Actualizado:</b> Modificación de D1 y <code>schema.sql</code> añadiendo loc_ve y loc_mod en <code>user_permissions_matrix</code>.</li>
                </ul>

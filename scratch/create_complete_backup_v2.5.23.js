...
async function runBackup() {
    ...
    const payload = {
        ...
        subject: `📦 BACKUP COMPLETO EYE STAFF - ${version} (Base de Datos + Frontend + Backend)`,
        html: `
            <div style="font-family: sans-serif; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eaeaea; border-radius: 12px; background: #fafafa;">
                ...
                <h3 style="color: #4b5563;">Cambios realizados en v2.5.00 - v2.5.23:</h3>
                <ul>
                    <li><b>Generador Presupuestos:</b> Se eliminó el botón derecho de edición ya que se usa el ID del presupuesto directamente.</li>
                    <li><b>Generador Presupuestos PDF:</b> Se corrigió la generación del archivo PDF que se quedaba en "generando" arreglando la función printData.</li>
                    <li><b>Fechas en Presupuestos:</b> Se corrigió la pérdida del valor de fecha original al modificar y guardar un presupuesto.</li>
                    <li><b>Campos de Presupuesto:</b> Se eliminó "Atención a", se renombró el campo a "CONTACTO", y en empresa cliente se dejó solo "EMPRESA".</li>
                    <li><b>Exportación:</b> Se eliminó la función de generar Excel en presupuestos.</li>
                    <li><b>Historial Presupuestos:</b> Se agregaron las columnas CONTACTO y EMPRESA en la tabla, reordenando los campos de cliente.</li>
                    <li><b>Alquiler de Equipos:</b> Se habilitó y activó completamente la lógica de Alquiler de Equipos y logística en el frontend, mostrando tarjetas funcionales en lugar del mensaje de construcción.</li>
                    <li><b>Estatus APROBADO de Presupuestos:</b> Se cambió el color del estatus APROBADO a verde visualmente en el historial.</li>
                    <li><b>Seguridad (PIN):</b> Se añadió una validación de seguridad (PIN/Contraseña) antes de permitir modificar un presupuesto que ya se encuentra en estatus "APROBADO".</li>
                    <li><b>Backend Login:</b> Se actualizó el endpoint de login del Cloudflare Worker para devolver el 'pin_hash' de la base de datos hacia el frontend para las validaciones locales de seguridad.</li>
                </ul>
                ...
                <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="border: 1px solid #d1d5db; padding: 8px;">Código frontend de la aplicación (versión ${version}).</td>
                        </tr>
                        <tr>

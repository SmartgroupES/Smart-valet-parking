    ...
    const payload = {
        ...
        html: `
            <div style="font-family: sans-serif; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eaeaea; border-radius: 12px; background: #fafafa;">
                ...
                <ul>
                    <li><b>Entorno Staging (Pruebas):</b> Implementado CI/CD completo con GitHub Actions apuntando al subdominio <code>*.workers.dev</code> y base de datos <code>d1-staging</code>.</li>
                </ul>
